  ...
  extras = hackage:
    {
      packages = {
        ...
        "persistent-template" = (((hackage.persistent-template)."2.8.3.1").revisions).default;
        ...
        "servant-client" = (((hackage.servant-client)."0.18").revisions).default;
        "servant-client-core" = (((hackage.servant-client-core)."0.18").revisions).default;
        "servant-server" = (((hackage.servant-server)."0.18").revisions).default;
